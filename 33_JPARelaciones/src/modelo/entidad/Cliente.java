...
public class Cliente {
	...
	// Relacion de uno a uno con dos tablas
	// Siempre tenemos dos tipos de relaciones,
	...
	// hacemos la relacion bidirecional, es decir, ambas entidades
	// se ven. Solo es obligario ponerla en el lado que tenga la
	// fk, en este caso la fk la tiene la clase DatosBancarios
